...
import com.rameses.anubis.web.MultipartRequest;
...
public class MultipartFilter implements javax.servlet.Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException 
    {
        ...
        {    
            ...
            Object status = null;
            try {
                status = p.getActionManager().getActionCommand(CmsWebConstants.FILE_UPLOAD_CHECK_STATUS_CMD).execute(param);
            }
            catch(Exception e) {
                e.printStackTrace();
            }
        ...
        else 
        {
            ...
            if( isMultipart ) 
            {
                ...
                hreq.setAttribute(FILE_ATTR_KEY, file);
